...
<aside class="main-sidebar sidebar-dark-primary elevation-4">
    ...
    <a href="index3.html" class="brand-link">
        ...
        <span class="brand-text font-weight-light">DiChatin</span>
    </a>
    ...
    <div class="sidebar" style="background-color: black">
        ...
        <nav class="mt-2">
         ...
         with font-awesome or any other icon font library -->
                ...
                <li class="nav-item">
                    <a href="discussion.php" class="nav-link {{ $title === 'Discussion' ? 'active' : '' }} ">
                ...
                <li class="nav-item">
                    <a href="pages/calendar.html" class="nav-link {{ $title === 'Weather' ? 'active' : '' }} ">
                ...
                <li class="nav-item">
                    <a href="pages/gallery.html" class="nav-link {{ $title === 'News' ? 'active' : '' }} ">
